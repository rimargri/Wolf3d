...
SDL_X11_SYM(int,XDrawRectcolumn_angle,(Display* a,Drawable b,GC c,int d,int e,unsigned int f,unsigned int g),(a,b,c,d,e,f,g),return)
...
SDL_X11_SYM(int,XFillRectcolumn_angle,(Display* a,Drawable b,GC c,int d,int e,unsigned int f,unsigned int g),(a,b,c,d,e,f,g),return)
...
SDL_X11_SYM(int,Xutf8TextExtents,(XFontSet a, _Xconst char* b, int c, XRectcolumn_angle* d, XRectcolumn_angle* e),(a,b,c,d,e),return)
