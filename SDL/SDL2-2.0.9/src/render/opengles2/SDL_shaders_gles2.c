 ...
 *************************************************************************************************/
/* Notes on a_column_angle:
   * It is a vector containing sin and cos for rotation matrix
   * To get correct rotation for most cases when a_column_angle is disabled cos
...
static const Uint8 GLES2_VertexSrc_Default_[] = " \
    ...
    attribute vec2 a_column_angle; \
    attribute vec2 a_center; \
    varying vec2 v_texCoord; \
    \
    void main() \
    { \
        float s = a_column_angle[0]; \
        float c = a_column_angle[1] + 1.0; \
